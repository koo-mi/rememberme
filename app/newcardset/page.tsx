    ...
    <main className="flex flex-col p-4 gap-3 max-w-7xl m-auto">
      ...
      <form className="flex flex-col gap-3">
        ...
        {quizInput.map((item, i) => (
          <CardInput key={i} item={item} i={i} changeQuizInput={changeQuizInput} removeInput={removeInput}/>
        ))}
        <div className="flex justify-center items-center rounded border border-black" onClick={addInput}>
