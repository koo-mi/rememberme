  ...
  return (
    <div className="flex flex-col p-3 mt-3 border border-black rounded">
      ...
      <div className="flex flex-col gap-1 p-2 pt-4">
        <input className="border-b border-black" type="text" value={item.front || ""} onChange={handleFrontChange} />
        <label className="text-xs text-gray-400">Front</label>
      </div>
      <div className="flex flex-col gap-1 p-2">
        <input className="border-b border-black" type="text" value={item.back || ""} onChange={handleBackChange}/>
